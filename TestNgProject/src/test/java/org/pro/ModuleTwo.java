...
public class ModuleTwo extends BaseClass {
	...
	private void tc2() throws IOException, InterruptedException {
		...
		windowMaximize();
		Thread.sleep(5000);
		SimpleDateFormat dateFormat = new SimpleDateFormat("dd-m-yyyy//h-m-s");
		Date date = new Date();
		takeScreenShot(
				"C:\\Users\\LENOVO\\git\\seleniumproject\\TestNgProject\\screenshots\\"+dateFormat.format(date)+".png");
